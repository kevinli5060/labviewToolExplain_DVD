...
<Library LVVersion="11008008">
	...
	<Item Name="单例.lvclass" Type="LVClass" URL="../单例类/单例.lvclass">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
	</Item>
	<Item Name="读取信息.vi" Type="VI" URL="../读取信息.vi"/>
	<Item Name="获取实例.vi" Type="VI" URL="../获取实例.vi"/>
	<Item Name="输入信息.vi" Type="VI" URL="../输入信息.vi"/>
</Library>
