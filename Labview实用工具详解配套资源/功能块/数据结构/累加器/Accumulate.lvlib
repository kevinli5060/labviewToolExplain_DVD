...
<Library LVVersion="12008004">
	...
	<Item Name="VI" Type="Folder">
		...
		<Item Name="Accumulate(CDB).vi" Type="VI" URL="../Accumulate(CDB).vi"/>
		<Item Name="Accumulate(CSG).vi" Type="VI" URL="../Accumulate(CSG).vi"/>
		<Item Name="Accumulate(DBL).vi" Type="VI" URL="../Accumulate(DBL).vi"/>
		<Item Name="Accumulate(I8).vi" Type="VI" URL="../Accumulate(I8).vi"/>
		<Item Name="Accumulate(I16).vi" Type="VI" URL="../Accumulate(I16).vi"/>
		<Item Name="Accumulate(I32).vi" Type="VI" URL="../Accumulate(I32).vi"/>
		<Item Name="Accumulate(I64).vi" Type="VI" URL="../Accumulate(I64).vi"/>
		<Item Name="Accumulate(SGL).vi" Type="VI" URL="../Accumulate(SGL).vi"/>
		<Item Name="Accumulate(U8).vi" Type="VI" URL="../Accumulate(U8).vi"/>
		<Item Name="Accumulate(U16).vi" Type="VI" URL="../Accumulate(U16).vi"/>
		<Item Name="Accumulate(U32).vi" Type="VI" URL="../Accumulate(U32).vi"/>
		<Item Name="Accumulate(U64).vi" Type="VI" URL="../Accumulate(U64).vi"/>
	</Item>
</Library>
